...
export const projects: Array<Project> = [
  ...
  {
    id: 1.6,
    name: "Kalenjin hymns lyrics web app",
    languages: ["Typescript", "react"],
    frameworks: ["React", "typescript", "Tailwind", "Remix js"],
    short_des:
      "A web application for Kalenjin hymns lyrics, a collection of Kalenjin hymns lyrics for the Kalenjin community in Kenya and Sabiny community  in Uganda",
    long_des: `A minimalistic single page applicaton of Kalenjin hymns lyrics, a collection of Kalenjin hymns lyrics for the Kalenjin community in Kenya and Sabiny community  in Uganda. The app allows users to use a powerful search functionality to search keywords, song numbers,chorus and part of lyrics verse. Additionally, users can copy or share lyrics to their favourite plaatforms of choice`,

    year: 2025,
    repo: "",
    link: "https://tienwogik-ab-kalosunet.vercel.app/",
    openSource: false,
  },
  {
    id: 1.5,
    ...
    frameworks: ["React", "typescript", "Tailwind", "Remix js"],
    short_des:
      "A website showcasing the projects and services offered by Sky developers, an engineering and construction company based in Kenya",
