...
export default function PRSidebar({
  ...
  return (
    <div
      className={`fixed lg:static w-80   ${darkMode ? "bg-gray-900 text-white" : "bg-white text-gray-900"}  shadow-lg min-h-screen transform ${
      ...
      <div className="flex flex-col h-full p-6">
        <div className="text-center mb-8">
          ...
          <p className={`${darkMode ? "text-white" : "text-gray-600"}  mt-2`}>
            PR & Communications Pro
          </p>
          <p className={`${darkMode ? "text-white" : "text-gray-600"} text-sm`}>
            Photographer & Print Journalist
          </p>
          <p
            className={`${darkMode ? "text-white" : "text-gray-600"} text-sm cursor-pointer mt-4`}
          >
            <button
              onClick={() => {
                location.href = "/";
            ...
            >
              Web developer <ExternalLink className="inline ml-2 " size={20} />
            </button>
          </p>
        </div>
        ...
        <div className="flex flex-col items-end mt-4">
          <button
            className="bg-blue-800 p-2 w-full rounded-md text-white"
            onClick={() => setOpen()}
          >
            Contact me
          </button>
